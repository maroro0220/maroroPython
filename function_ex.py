...
while number1 != -1:
    ...
    if number2 != 0:
        ...
        prn_format = '{:5} / {:5} = {:6.2f}'.format( number1, number2, result )
        print( prn_format )
    else:
    ...
    print()
    number1 = int( input( 'Input number1 : ' ) )
print( '{:=^50}\n'.format( ' End Program 1 ' ) )

print( '{0:=^50}'.format( ' problem 2 ' ) )
...
print( '{:=^50}\n'.format( ' End Program 2 ' ) )

print( '{0:=^50}'.format( ' problem 3 ' ) )
...
print( '{:=^50}\n'.format( ' End Program 3 ' ) )

print( '{0:=^50}'.format( ' problem 4 ' ) )
...
print( '{:=^50}\n'.format( ' End Program 4 ' ) )

print( '{0:=^50}'.format( ' problem 5 ' ) )
...
print( '\n{:=^50}\n'.format( ' End Program 5 ' ) )

print( '{0:=^50}'.format( ' problem 6 ' ) )
menu = '''
1. add
2. subtract
3. multiply
...
print( '\n{:=^50}\n'.format( ' End Program 6 ' ) )

print( '{0:=^50}'.format( ' problem 7 ' ) )
